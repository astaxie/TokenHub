...
func (s *Server) routes() {
	...
	s.registerSingleMethodRoute(http.MethodPost, "/v1/live", s.gatewayInFlight(s.handleCodexVoiceCallCreate), jsonMethodNotAllowed(http.MethodPost))
	s.registerSingleMethodRoute(http.MethodPost, "/v1/realtime/calls", s.gatewayInFlight(s.handleCodexVoiceCallCreate), jsonMethodNotAllowed(http.MethodPost))
	s.registerDynamicGETRoute("/v1/live/{call_id}", s.gatewayInFlight(s.handleCodexVoiceLiveSideband), jsonMethodNotAllowed(http.MethodGet))
	s.registerSingleMethodRoute(http.MethodGet, "/v1/realtime", s.gatewayInFlight(s.handleCodexVoiceRealtimeSideband), jsonMethodNotAllowed(http.MethodGet))
