...
// Auto mode supports administrator-configured self-hosted services, including
// private DNS names. Strict is the default. RFC1918/ULA literals are allowed
// in both modes when the CIDR list is empty. Unknown modes fail closed.
