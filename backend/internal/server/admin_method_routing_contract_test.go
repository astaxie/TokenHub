...
func adminMethodRouteContracts() []adminMethodRouteContract {
	return []adminMethodRouteContract{
		...
		{name: "xai_oauth_start_device", allowedMethod: http.MethodPost, wrongMethod: http.MethodGet, path: "/api/admin/provider-account-oauth/xai/start-device", userWantStatus: http.StatusForbidden, userWantCode: "admin_forbidden"},
		{name: "xai_oauth_poll", allowedMethod: http.MethodPost, wrongMethod: http.MethodGet, path: "/api/admin/provider-account-oauth/xai/poll", userWantStatus: http.StatusForbidden, userWantCode: "admin_forbidden"},
