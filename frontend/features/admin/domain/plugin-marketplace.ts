...
export function pluginMarketplaceDisplay(
  ...
  return {
    ...
    summary: firstNonEmpty(localization.summary, marketplace?.summary, plugin?.description, plugin?.name, plugin?.id),
    description: firstNonEmpty(localization.description, localization.summary, plugin?.description, marketplace?.summary, plugin?.name, plugin?.id),
