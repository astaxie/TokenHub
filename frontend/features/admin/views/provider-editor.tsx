...
export function ProviderUpsertModal({
  ...
  function validateCreateStep(targetStep = createStep) {
    ...
    if (targetStep === 2 && requiresCatalogAcknowledgement && !acknowledgedCatalogTerms) {
  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    if (mode === "create" && requiresCatalogAcknowledgement && !acknowledgedCatalogTerms) {
      setError(tx("请先确认个人套餐的适用性与风险。"));
      return;
    }
    setLoading(true);
    ...
    <div className="modal-backdrop" role="presentation">
      <form className={mode === "create" ? "modal provider-modal provider-wizard-modal" : "modal provider-modal"} ref={modalRef} onSubmit={submit}>
        ...
        <div className="modal-actions">
          ...
          <button className="button" disabled={loading || (mode === "create" && createStep >= 2 && requiresCatalogAcknowledgement && !acknowledgedCatalogTerms)} type="submit">
            {mode === "create"
