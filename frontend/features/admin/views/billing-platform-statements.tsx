...
type StatementRow = { id: string; request_id: string; occurred_at: string; provider_id?: string; provider_name?: string; resource_id?: string; resource_name?: string; model: string; project_id?: string; project_name?: string; amount_usd?: string; status: string; evidence_incomplete?: boolean; reason?: string; source: string };
