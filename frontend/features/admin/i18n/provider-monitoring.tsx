...
const ru: Record<string, string> = {
  "延迟优先取近24小时成功请求的中位总耗时；质量分综合可用率、延迟和资源健康。": "Задержка рассчитывается как медиана времени успешных запросов за последние 24 часа; оценка качества объединяет доступность, задержку и исправность ресурсов.",
