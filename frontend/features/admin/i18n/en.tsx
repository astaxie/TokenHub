export const enTranslations: Record<string, string> = {
    ...
    "选择使用上游 API Key，或接入插件账号资源池。": "Use an upstream API key or connect a plugin account resource pool.",
    ...
    "填写名称和 Base URL": "Enter the name and Base URL",
    ...
    "先在“连接”中填写 Base URL，这里会加载自定义渠道的上游模型。": "Enter the Base URL under Connection to load models from the custom upstream.",
    ...
    "适合订阅账号、多账号轮询或 OAuth 账号池，默认通道会自动推荐。": "Best for subscription accounts, multi-account rotation, or OAuth account pools. The default channel is recommended automatically.",
    ...
    "账号资源": "Account Resources", "无账号资源测试": "No account resource tests", "等待账号资源测试": "Waiting for account resource test",
    ...
    "确认禁用": "Confirm disable", "确认启用": "Confirm enable", "重置请求已完成，正在刷新额度。": "The reset request completed. Refreshing quota now.", "该重置请求此前已完成，正在刷新额度。": "This reset request had already completed. Refreshing quota now.", "受影响窗口": "Affected windows", "剩余重置次数": "Remaining reset credits", "查询中": "Loading", "最近可用次数过期": "Earliest available credit expires in", "最近可用次数过期时间": "Earliest available credit expires at", "选择要使用的重置次数": "Choose a reset credit", "重置次数": "Reset credit", "重置套餐": "Reset Plan", "当前剩余重置次数": "Current reset credits", "已使用的重置次数无法恢复。": "Used reset credits cannot be restored.", "正在重置": "Resetting", "正在提交重置并刷新用量与重置次数，请勿关闭页面或重复操作。": "Submitting the reset and refreshing usage and reset credits. Do not close this page or repeat the operation.", "确认重置": "Confirm reset", "选中次数过期": "Selected credit expires in", "选中次数过期时间": "Selected credit expires at", "可用重置次数明细暂不可用、已过期或不一致，请点击“刷新用量与重置次数”重新查询。": "Reset-credit details are unavailable, expired, or inconsistent. Refresh usage and reset credits to query them again.", "刷新用量与重置次数": "Refresh usage and reset credits", "查询用量与重置次数": "Query usage and reset credits", "该操作已经提交。为避免重复消耗，请保留本弹窗并使用同一次操作重试，直到获得确定结果。": "This operation was submitted. To avoid consuming another credit, keep this dialog open and retry the same operation until its result is known.", "选中的重置次数已经过期，请取消并刷新额度。": "The selected reset credit has expired. Cancel and refresh quota.", "无法保存本次重置的安全状态，请检查浏览器存储权限后重试。": "The safety state for this reset could not be saved. Check browser storage permissions and try again.", "上游结果未知。请保留当前弹窗并直接重试，系统会复用同一个幂等键和重置次数。": "The upstream outcome is unknown. Keep this dialog open and retry here so the same idempotency key and reset credit are reused.", "重置请求返回未知结果。请保留当前弹窗并直接重试。": "The reset request returned an unknown result. Keep this dialog open and retry here.",
    ...
    "成本评分 1-100": "Cost Score 1-100", "缓存写成本 USD/1M": "Cache-write cost USD/1M", "5 分钟缓存写成本 USD/1M": "5-minute cache-write cost USD/1M", "1 小时缓存写成本 USD/1M": "1-hour cache-write cost USD/1M",
