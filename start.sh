...
BACKEND_VAR_DEFAULTS=(
  ...
  "TOKENHUB_GRACEFUL_SHUTDOWN_SECONDS=150"
	"TOKENHUB_AGENT_CATALOG_FILE=$ROOT_DIR/data/agent-catalog.yaml"
	"TOKENHUB_A2A_ENABLED=false"
	"TOKENHUB_A2A_ALLOW_PRIVATE_UPSTREAMS=true"
	"TOKENHUB_A2A_MAX_AGENT_HOPS=8"
	"TOKENHUB_A2A_MAX_MODEL_CALLS=32"
	"TOKENHUB_A2A_MAX_MCP_CALLS=64"
	"TOKENHUB_A2A_MAX_RUNTIME_SECONDS=900"
	"TOKENHUB_A2A_MAX_TOKENS=200000"
	"TOKENHUB_A2A_MAX_COST_USD=10"
	"TOKENHUB_A2A_MAX_CONCURRENCY=8"
