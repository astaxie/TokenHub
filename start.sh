...
(
  ...
  backend_env=(
    ...
    TOKENHUB_UPSTREAM_NON_STREAM_TIMEOUT_SECONDS="$TOKENHUB_UPSTREAM_NON_STREAM_TIMEOUT_SECONDS"
    TOKENHUB_UPSTREAM_STREAM_IDLE_TIMEOUT_SECONDS="$TOKENHUB_UPSTREAM_STREAM_IDLE_TIMEOUT_SECONDS"
