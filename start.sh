...
BACKEND_VAR_DEFAULTS=(
  ...
  "TOKENHUB_PLUGIN_DIR=$ROOT_DIR/backend/data/plugins"
  "TOKENHUB_PLUGIN_MARKETPLACE_URL="
  "TOKENHUB_TRUSTED_PROXY_CIDRS="
  "TOKENHUB_PROVIDER_UPSTREAM_ACCESS_MODE=strict"
  "TOKENHUB_PROVIDER_UPSTREAM_PROXY_LOCAL=false"
  ...
  "TOKENHUB_BILLING_REDIS_URL="
  "TOKENHUB_GRACEFUL_SHUTDOWN_SECONDS=150"
  "TOKENHUB_SEMANTIC_ROUTING_ENABLED=false"
  "TOKENHUB_SEMANTIC_ROUTING_PROJECTS="
  "TOKENHUB_TYPESAFE_API_KEY="
