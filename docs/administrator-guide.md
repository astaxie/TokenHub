...
For guided calculations, confirmed model price changes, and platform statements, see [model pricing and billing](billing-pricing.md#model-price-changes).
